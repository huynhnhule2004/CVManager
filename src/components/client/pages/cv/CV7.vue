...
const cv = ref(  {
        avatarUrl: '',
        name: 'Olivia Taylor',
        specialize: 'Content Writer',
        phone: '+84123456794',
        email: 'olivia.taylor@gmail.com',
        website: 'oliviataylorwrites.com',
        location: 'Sydney, Australia',
        birthday: '1994-07-14',
        university: 'University of Sydney',
        introduction: 'Content writer with a passion for creating engaging and informative articles...',
        experiences: [
            {
                title: 'Content Manager',
                year: '2021 - Present',
                company: 'Creative Content Co.',
                description: 'Managed content strategies and produced high-quality articles...',
            },
            {
                title: 'Freelance Writer',
                year: '2016 - 2021',
                company: 'Self-Employed',
                description: 'Worked with clients to produce SEO-optimized blog posts and articles...',
            },
        ],
        skills: ['SEO Writing', 'Copywriting', 'Content Strategy', 'Editing', 'Proofreading'],
        projects: [
            {
                title: 'Blog Series for JKL Travel',
                year: '2022',
                website: 'jkltravel.com',
                role: 'Content Creator',
                description: 'Wrote a series of travel blogs to promote tourism...',
                tasks: ['Research topics', 'Write and edit articles', 'Optimize for SEO'],
            },
        ],
    },);
...
const saveCV = () => {
    ...
    const cvData = {
        ...
        cvName: cv.value.cvName || "Mẫu CV Content Writer", // Tên CV mặc định nếu không nhập
