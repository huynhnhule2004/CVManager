...
const cv = ref({
    avatarUrl: '',
    name: 'Nguyễn Thị A',
    specialize: 'Chief Accountant',
    phone: '+84123456789',
    email: 'nguyenthia@gmail.com',
    website: 'accountingpro.com',
    location: 'HCMC - Vietnam',
    birthday: '01/01/1990',
    university: 'University of Economics HCMC',
    introduction: 'I am an accountant with many years of experience in managing corporate finances...',
    experiences: [
        {
            title: 'Chief Accountant',
            year: '2020 - Present',
            company: 'ABC Ltd.',
            description: 'Manage finances, prepare financial reports, analyze and plan financial strategies for the company...',
        },
        {
            title: 'Accountant',
            year: '2015 - 2020',
            company: 'XYZ Ltd.',
            description: 'Handle daily accounting tasks, prepare tax reports, manage invoices and receipts...',
        },
    ],
    skills: ['Financial Accounting', 'Report Analysis', 'Advanced Excel', 'Budget Management', 'SAP System'],
    designSkills: ['Financial Analysis', 'Budget Planning', 'Tax Management'],
    designTools: ['Excel', 'QuickBooks', 'SAP'],
    portfolio: [
        {
            title: 'Financial Management System',
            year: '2022',
            website: 'www.accountingpro.com',
            role: 'Chief Accountant',
            description: 'Developed a financial management system for the business, helping save costs and optimize accounting processes...',
            tasks: ['Financial Planning', 'Cash Flow Management', 'Financial Reporting'],
        },
    ],
    experiences: [
        {
...
const saveCV = () => {
    ...
    const cvData = {
        ...
        cvName: cv.value.cvName || "Mẫu CV KẾ TOÁN", // Tên CV mặc định nếu không nhập
