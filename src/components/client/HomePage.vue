        ...
        <div class="page-inner w-75 m-auto">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">CV xin việc</li>
                </ol>
            </nav>
            <h3 class="text-center text-uppercase">Mẫu CV Xin Việc online đẹp, tạo cv online và tải cv miễn phí ngay</h3>
            <div class="ribbon">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body" style="background-color: #f7f7f7; padding: 20px;">
                            <h5 class="card-title mb-3" style="font-family: 'Roboto', sans-serif; font-weight: bold;">
                                {{ cv.title }}</h5>
                            <router-link :to="cv.link" class="btn btn-primary w-100" style="background-color: #007bff; color: white; font-weight: bold;">
                                Sử dụng mẫu này
                            </router-link>
                        </div>
                    </div>
...
.pagination .page-item.active .page-link {
    ...
    border-color: #007bff;     /* Đổi màu border khi trang hiện tại */
}
</style>